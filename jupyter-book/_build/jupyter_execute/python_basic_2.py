...
# '[무한 원숭이 정리](https://ko.wikipedia.org/wiki/%EB%AC%B4%ED%95%9C_%EC%9B%90%EC%88%AD%EC%9D%B4_%EC%A0%95%EB%A6%AC)'는 원숭이가 무한히 타이핑을 하면 어떤 문장도 언젠가는 정확하게 타이핑할 수 있다는 정리이다. 
# 다음 세 함수를 구현한다. 
# 
